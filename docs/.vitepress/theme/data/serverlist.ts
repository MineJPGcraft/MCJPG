export interface MinecraftServer {
  ...
  export const servers: MinecraftServer[] = [
    ...
    },
   {
      ...
      link: 'minecraft://?addExternalServer=starry-isles|starry-isles.play-mc.space:20069',
      ip: ''
    },
    {
      id: '45',
    ...
    },
    {
      ...
      description: '1.21.1-1.21.8版本的高版本生存服务器 使用外置登录 服务器包含粘液科技 公会系统 领地保护 经济贸易等丰富玩法 期待你的加入',
